...
class Animal(Living):
    ...
    def __init__(self, all_sprites, all_plants, all_herbivores, all_carnivores, x, y, min_reproduction_distance,
                 max_reproduction_distance, life_expectancy, reproductive_cooldown, mature_ratio, old_ratio,
                 given_speed,
        ...
        super().__init__(all_sprites, all_plants, all_herbivores, all_carnivores, x, y, life_expectancy,
                         reproductive_cooldown, mature_ratio, old_ratio, min_reproduction_distance,
                         max_reproduction_distance)
